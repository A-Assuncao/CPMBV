...
UPDATE_URL = 'https://github.com/A-Assuncao/auto-saida-temporaria-canaime/releases/latest/download/'
...
def update_application(current_version):
    ...
    if latest_version != current_version:
        ...
        update_exe_path = os.path.join(os.getcwd(), f'auto-saida-temporaria-canaime-{latest_version}.exe')
